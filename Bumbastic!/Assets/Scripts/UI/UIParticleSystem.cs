...
public class UIParticleSystem : MaskableGraphic
{
    ...
    protected bool Initialize()
    {
        ...
        if (_particleSystem == null)
        {
            ...
            _particleSystemMain.scalingMode = ParticleSystemScalingMode.Local;
        ...
        if (_particles == null)
        {
            _particles = new ParticleSystem.Particle[_particleSystemMain.maxParticles];
        }
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            Vector2 position = (_particleSystemMain.simulationSpace == ParticleSystemSimulationSpace.Local ? particle.position : _transform.InverseTransformPoint(particle.position));
            ...
            // apply scale
            if (_particleSystemMain.scalingMode == ParticleSystemScalingMode.Shape)
            {
